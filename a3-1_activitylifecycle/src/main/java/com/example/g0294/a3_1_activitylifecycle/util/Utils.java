...
package com.example.g0294.a3_1_activitylifecycle.util;
...
public class Utils {
  ...
  /**
   * Helper method to print out the lifecycle state of each Activity. Note this has been wrapped in
   * a Handler to delay the output due to overlaps in lifecycle state changes as one Activity
   * launches another.
   * 
   * @link 
